...
async function main() {
    const res = await got("https://api.github.com/repos/ludvigalden/abon/releases", {
        responseType: "json",
    });
    ...
    // Add compare link
    finalMessage.push(`https://github.com/ludvigalden/abon/compare/${firstVersion}...${lastVersion}`);
